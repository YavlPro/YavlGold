...
function buildProfileMarkdown(options = {}) {
    ...
    const lines = [
        ...
        '- Fiados activos son montos por cobrar vigentes; los fiados ya transferidos quedan como historial, pero no inflan el saldo pendiente.',
        ...
        `- Fiados activos: ${safeMoney(moneyStats.pendingUsd)}`,
        ...
        `- Resultado potencial (si cobras todos los fiados activos): ${safeMoney(potentialResultUsd)}`,
