...
-- BUGFIX: Cartera Viva must not count a pending row as active debt when
-- it already carries transfer markers (for example transferred_income_id),
-- even if legacy transfer_state stayed as "active".
...
'Agregacion buyer-centric de Cartera Viva V1. El saldo pendiente activo respeta marcadores de transferencia legacy.';
